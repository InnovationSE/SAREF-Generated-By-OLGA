...
public  class DoorSwitch implements IDoorSwitch {
	...
	public DoorSwitch(String id) {
		super();
		this.id = "https://w3id.org/saref#" + id;
		relations = new HashMap<String, List<RefId>>();
		hasFunctionSomeOpenCloseFunction = new ArrayList<>();
		hasStateSomeOpenCloseState = new ArrayList<>();
	...
	{
		return "https://w3id.org/saref#DoorSwitch";
	}
	...
	private List<RefId> hasFunctionSomeOpenCloseFunction;
