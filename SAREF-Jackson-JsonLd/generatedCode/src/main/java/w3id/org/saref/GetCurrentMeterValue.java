...
public class GetCurrentMeterValue implements IGetCurrentMeterValueCommand {

	Map<String, List<RefId>> relations;
	
	public GetCurrentMeterValue(String id) {
		super();
		this.id = "https://w3id.org/saref#" + "GetCurrentMeterValue";
