...
import w3id.org.saref.GetCurrentMeterValue;



public  class GetCurrentMeterValueCommand implements IGetCurrentMeterValueCommand {

	Map<String, List<RefId>> relations;
	
	public GetCurrentMeterValueCommand(String id) {
		super();
		this.id = "https://w3id.org/saref#" + id;
		relations = new HashMap<String, List<RefId>>();
		GetCurrentMeterValue getcurrentmetervalue = new GetCurrentMeterValue("GetCurrentMeterValue");
	...
	{
		return "https://w3id.org/saref#GetCurrentMeterValueCommand";
	}
