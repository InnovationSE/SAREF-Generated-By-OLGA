...
import w3id.org.saref.GetMeterHistory;



public  class GetMeterHistoryCommand implements IGetMeterHistoryCommand {

	Map<String, List<RefId>> relations;
	
	public GetMeterHistoryCommand(String id) {
		super();
		this.id = "https://w3id.org/saref#" + id;
		relations = new HashMap<String, List<RefId>>();
		GetMeterHistory getmeterhistory = new GetMeterHistory("GetMeterHistory");
	...
	{
		return "https://w3id.org/saref#GetMeterHistoryCommand";
	}
