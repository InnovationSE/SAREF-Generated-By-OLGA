...
public class GetSensingData implements IGetSensingDataCommand {

	Map<String, List<RefId>> relations;
	
	public GetSensingData(String id) {
		super();
		this.id = "https://w3id.org/saref#" + "GetSensingData";
	...
	{
		return "https://w3id.org/saref#GetSensingDataCommand";
	}
