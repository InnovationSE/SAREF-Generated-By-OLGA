...
public  class LightSwitch implements ILightSwitch {
	...
	public LightSwitch(String id) {
		...
		hasFunctionSomeOnOffFunction = new ArrayList<>();
		consistsOfSomeSwitch = new ArrayList<>();
		hasStateSomeOnOffState = new ArrayList<>();
		measuresPropertySomeLight = new ArrayList<>();
		offersSomeSwitchOnService = new ArrayList<>();
		hasFunctionSomeActuatingFunction = new ArrayList<>();
	...
	{
		return "https://w3id.org/saref#LightSwitch";
	}
	...
	private List<RefId> hasFunctionSomeOnOffFunction;
	public void addhasFunctionSome(IOnOffFunction parameter)
	{
		hasFunctionSomeOnOffFunction.add(parameter.getRefId());
	}
	@JsonInclude(Include.NON_EMPTY)
	...
	private List<RefId> hasStateSomeOnOffState;
	public void addhasStateSome(IOnOffState parameter)
	{
		hasStateSomeOnOffState.add(parameter.getRefId());
	}
	@JsonInclude(Include.NON_EMPTY)
	@JsonldProperty("https://w3id.org/saref#measuresProperty") 
	private List<RefId> measuresPropertySomeLight;
	public void addmeasuresPropertySome(ILight parameter)
	{
		measuresPropertySomeLight.add(parameter.getRefId());
	}
	@JsonInclude(Include.NON_EMPTY)
	@JsonldProperty("https://w3id.org/saref#offers") 
	private List<RefId> offersSomeSwitchOnService;
	public void addoffersSome(ISwitchOnService parameter)
	{
		offersSomeSwitchOnService.add(parameter.getRefId());
	}
	@JsonInclude(Include.NON_EMPTY)
	@JsonldProperty("https://w3id.org/saref#accomplishes") 
	private List<RefId> accomplishesLighting;
	public void addaccomplishes(Lighting parameter)
	{
		accomplishesLighting.add(parameter.getRefId());
	}			
	...
	{
		hasFunctionSomeActuatingFunction.add(parameter.getRefId());
	}
	...
	public List<RefId> gethasFunctionActuatingFunction()
	{
		return hasFunctionSomeActuatingFunction;
	}
	@JsonInclude(Include.NON_EMPTY)
