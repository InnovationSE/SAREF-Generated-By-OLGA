...
public  class Multimedia implements IMultimedia {
	...
	{
		return "https://w3id.org/saref#Multimedia";
	}
	...
	private List<RefId> accomplishesEntertainment;
	public void addaccomplishes(Entertainment parameter)
	{
		accomplishesEntertainment.add(parameter.getRefId());
	}			
