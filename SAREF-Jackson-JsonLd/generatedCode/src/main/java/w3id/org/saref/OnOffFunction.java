...
public  class OnOffFunction implements IOnOffFunction {
	...
	public OnOffFunction(String id) {
		super();
		this.id = "https://w3id.org/saref#" + id;
		relations = new HashMap<String, List<RefId>>();
		hasCommandOnlyOffCommand = new ArrayList<>();
		hasCommandOnlyOnCommand = new ArrayList<>();
		hasCommandOnlyToggleCommand = new ArrayList<>();
	...
	{
		return "https://w3id.org/saref#OnOffFunction";
	}
	
	@JsonInclude(Include.NON_EMPTY)
	@JsonldProperty("https://w3id.org/saref#hasCommand") 
	private List<RefId> hasCommandOnlyOffCommand;
	public void addhasCommandOnly(IOffCommand parameter)
	{
		hasCommandOnlyOffCommand.add(parameter.getRefId());
	}
	@JsonInclude(Include.NON_EMPTY)
	@JsonldProperty("https://w3id.org/saref#hasCommand") 
	private List<RefId> hasCommandOnlyOnCommand;
	public void addhasCommandOnly(IOnCommand parameter)
	{
		hasCommandOnlyOnCommand.add(parameter.getRefId());
	}
	@JsonInclude(Include.NON_EMPTY)
	@JsonldProperty("https://w3id.org/saref#hasCommand") 
	private List<RefId> hasCommandOnlyToggleCommand;
