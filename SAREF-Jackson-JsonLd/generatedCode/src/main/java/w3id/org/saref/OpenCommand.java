...
public  class OpenCommand implements IOpenCommand {
	...
	{
		return "https://w3id.org/saref#OpenCommand";
	}
	...
	private List<RefId> actsUponOnlyOpenCloseState;
	public void addactsUponOnly(IOpenCloseState parameter)
	{
