...
import w3id.org.saref.IPauseCommand;

import saref.jsonld.util.RefId;

public class Pause implements IPauseCommand {

	Map<String, List<RefId>> relations;
	
	public Pause(String id) {
		super();
		this.id = "https://w3id.org/saref#" + "Pause";
	...
	{
		return "https://w3id.org/saref#PauseCommand";
	}
