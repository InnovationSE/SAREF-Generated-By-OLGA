...
import w3id.org.saref.SetAbsoluteLevel;



public  class SetAbsoluteLevelCommand implements ISetAbsoluteLevelCommand {

	Map<String, List<RefId>> relations;
	
	public SetAbsoluteLevelCommand(String id) {
		super();
		this.id = "https://w3id.org/saref#" + id;
		relations = new HashMap<String, List<RefId>>();
		SetAbsoluteLevel setabsolutelevel = new SetAbsoluteLevel("SetAbsoluteLevel");
	...
	{
		return "https://w3id.org/saref#SetAbsoluteLevelCommand";
	}
	...
	public List<RefId> getactsUponMultiLevelState()
	{
		return actsUponOnlyMultiLevelState;
	}
	@JsonInclude(Include.NON_EMPTY)
