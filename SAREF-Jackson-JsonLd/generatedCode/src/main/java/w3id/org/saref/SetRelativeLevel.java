...
public class SetRelativeLevel implements ISetRelativeLevelCommand {

	Map<String, List<RefId>> relations;
	
	public SetRelativeLevel(String id) {
		super();
		this.id = "https://w3id.org/saref#" + "SetRelativeLevel";
	...
	{
		return "https://w3id.org/saref#SetRelativeLevelCommand";
	}
