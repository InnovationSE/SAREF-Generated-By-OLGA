...
public  class SmokeSensor implements ISmokeSensor {
	...
	public SmokeSensor(String id) {
		...
		measuresPropertySomeSmoke = new ArrayList<>();
		hasFunctionSomeSensingFunction = new ArrayList<>();
		consistsOfSomeSensor = new ArrayList<>();
		hasFunctionSomeEventFunction = new ArrayList<>();
	...
	{
		return "https://w3id.org/saref#SmokeSensor";
	}
	...
	private List<RefId> measuresPropertySomeSmoke;
