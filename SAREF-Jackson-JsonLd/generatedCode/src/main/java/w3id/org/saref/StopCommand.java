...
public  class StopCommand implements IStopCommand {
	...
	{
		return "https://w3id.org/saref#StopCommand";
	}
	...
	private List<RefId> actsUponOnlyStartStopState;
	public void addactsUponOnly(IStartStopState parameter)
	{
