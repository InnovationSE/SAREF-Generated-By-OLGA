...
public  class SwitchOnService implements ISwitchOnService {
	...
	public SwitchOnService(String id) {
		super();
		this.id = "https://w3id.org/saref#" + id;
		relations = new HashMap<String, List<RefId>>();
		representsSomeOnOffFunction = new ArrayList<>();
		isOfferedBySomeLightSwitch = new ArrayList<>();
	...
	{
		return "https://w3id.org/saref#SwitchOnService";
	}
	
	@JsonInclude(Include.NON_EMPTY)
	@JsonldProperty("https://w3id.org/saref#represents") 
	private List<RefId> representsSomeOnOffFunction;
	public void addrepresentsSome(IOnOffFunction parameter)
	{
	...
	public void addisOfferedBySome(ILightSwitch parameter)
	{
