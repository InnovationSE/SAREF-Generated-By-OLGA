...
public  class Time implements ITime {
	...
	public Time(String id) {
		...
		consistsOfSomeTemporalEntity = new ArrayList<>();
	...
	{
		return "https://w3id.org/saref#Time";
	}
	
	@JsonInclude(Include.NON_EMPTY)
	@JsonldProperty("https://w3id.org/saref#consistsOf") 
	private List<RefId> consistsOfSomeTemporalEntity;
	...
	public List<RefId> getconsistsOfTemporalEntity()
	{
		return consistsOfSomeTemporalEntity;
	}
