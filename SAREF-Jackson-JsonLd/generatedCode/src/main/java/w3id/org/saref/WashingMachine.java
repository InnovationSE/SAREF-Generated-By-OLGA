...
public  class WashingMachine implements IWashingMachine {
	...
	public WashingMachine(String id) {
		...
		hasFunctionSomeStartStopFunction = new ArrayList<>();
		hasStateSomeStartStopState = new ArrayList<>();
		hasProfileSomeProfile = new ArrayList<>();
	...
	{
		return "https://w3id.org/saref#WashingMachine";
	}
	...
	private List<RefId> hasFunctionSomeStartStopFunction;
