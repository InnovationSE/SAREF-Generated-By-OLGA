...
public  class EnergyMeter implements IEnergyMeter {
	...
	public EnergyMeter(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://w3id.org/saref#EnergyMeter"));
	}
	...
	public void addHasfunction_Some(IMeteringFunction parameter)
	{
