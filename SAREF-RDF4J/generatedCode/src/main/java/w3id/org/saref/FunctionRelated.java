...
public  class FunctionRelated implements IFunctionRelated {

	IRI newInstance;
	
	public FunctionRelated(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://w3id.org/saref#FunctionRelated"));
	}
