...
public  class GetCurrentMeterValueCommand implements IGetCurrentMeterValueCommand {
	...
	public GetCurrentMeterValueCommand(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://w3id.org/saref#GetCurrentMeterValueCommand"));
	}
