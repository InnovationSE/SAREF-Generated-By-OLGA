...
public  class LightSwitch implements ILightSwitch {
	...
	public LightSwitch(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://w3id.org/saref#LightSwitch"));
	}
	...
	public void addHasfunction_Some(IActuatingFunction parameter)
	{
		GLOBAL.model.add(newInstance, GLOBAL.factory.createIRI("https://w3id.org/saref#hasFunction"), parameter.iri());
	}
