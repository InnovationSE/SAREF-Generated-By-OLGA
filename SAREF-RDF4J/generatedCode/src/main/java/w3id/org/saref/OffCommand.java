...
public  class OffCommand implements IOffCommand {

	IRI newInstance;
	
	public OffCommand(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://w3id.org/saref#OffCommand"));
	}
	...
	public void addActsupon_Only(IOnOffState parameter)
	{
