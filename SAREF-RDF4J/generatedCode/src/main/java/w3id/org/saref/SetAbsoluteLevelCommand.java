...
public  class SetAbsoluteLevelCommand implements ISetAbsoluteLevelCommand {
	...
	public SetAbsoluteLevelCommand(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://w3id.org/saref#SetAbsoluteLevelCommand"));
	}
	...
	public void addActsupon_Only(IMultiLevelState parameter)
	{
