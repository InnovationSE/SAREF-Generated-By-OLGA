...
public  class StepUpCommand implements IStepUpCommand {

	IRI newInstance;
	
	public StepUpCommand(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://w3id.org/saref#StepUpCommand"));
	}
