...
public  class StopCommand implements IStopCommand {

	IRI newInstance;
	
	public StopCommand(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://w3id.org/saref#StopCommand"));
	}
	...
	public void addActsupon_Only(IStartStopState parameter)
	{
