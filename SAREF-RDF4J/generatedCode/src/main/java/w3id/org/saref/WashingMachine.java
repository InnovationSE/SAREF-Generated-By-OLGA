...
import w3id.org.saref.Appliance;
...
public  class WashingMachine implements IWashingMachine {
	...
	public WashingMachine(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://w3id.org/saref#WashingMachine"));
	}
